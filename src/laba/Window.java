...
public class Window {
	...
	private void initialize() throws IOException {
		...
		BufferedImage buttonIconUp = ImageIO
				.read(new File("D:\\All Kurai\\Óíèâåð\\2 êóðñ\\Òåõíîëîãèè ïðîãðàììèðîâàíèÿ\\ñòðåëêà ââåðõ.jpg"));
		...
		BufferedImage buttonIconLeft = ImageIO
				.read(new File("D:\\All Kurai\\Óíèâåð\\2 êóðñ\\Òåõíîëîãèè ïðîãðàììèðîâàíèÿ\\ñòðåëêà âëåâî.jpg"));
		...
		BufferedImage buttonIconRight = ImageIO
				.read(new File("D:\\All Kurai\\Óíèâåð\\2 êóðñ\\Òåõíîëîãèè ïðîãðàììèðîâàíèÿ\\ñòðåëêà âïðàâî.jpg"));
		...
		BufferedImage buttonIconDown = ImageIO
				.read(new File("D:\\All Kurai\\Óíèâåð\\2 êóðñ\\Òåõíîëîãèè ïðîãðàììèðîâàíèÿ\\ñòðåëêà âíèç.jpg"));
